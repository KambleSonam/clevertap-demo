...
self.addEventListener('push', function (event) {
  ...
  console.log(raiseNotificationViewedPath)
...
function onClick (event, redirectPath, notificationData) {
  ...
  if (event.action === 'action1') {
    ...
    if (typeof notificationData.notificationOptions.actions[0].deepLink !== 'undefined') {
      ...
      console.log('button0 ', notificationData.notificationOptions.actions[0].deepLink)
      silentRequest = false
    }
    ...
    if (typeof notificationData.notificationOptions.actions[1].deepLink !== 'undefined') {
      ...
      console.log('button1 ', notificationData.notificationOptions.actions[1].deepLink)
      silentRequest = false
    }
    ...
    if (typeof notificationData.deepLink !== 'undefined') {
      ...
      console.log('other is ', notificationData.deepLink)
      silentRequest = false
    }
  ...
  if (silentRequest) {
    console.log('finalDeepLink silent', finalDeepLink)
    fireSilentRequest(finalDeepLink)
  } else {
    console.log('finalDeepLink', finalDeepLink)
    clients.openWindow(finalDeepLink)
  }
  console.log('notif clicked ', finalDeepLink)
