...
if ("undefined" === typeof globalRedirectPath) var globalNotificationData, globalRedirectPath;
...
self.addEventListener("push", function(b) {
    ...
    localforage.setItem(e, b.data.text()).then(function(a) {})["catch"](function(a) {
